  ...
  return (
    <div className={styles.container}>
      ...
      <FormControl component="fieldset" error={!!formik.errors.gender}>
        ...
        />
                <FormHelperText style={{marginTop:"-2px"}}>{formik.errors.profleP}</FormHelperText>
        ...
        />
         <FormControl component="fieldset" error={!!formik.errors.gender&&formik.touched.gender}>
        ...
        >
          ...
          <FormControlLabel value="O" label="Other" control={<Radio />} />
        </RadioGroup>
        <FormHelperText style={{marginTop:"-2px"}}>
        {(!!formik.errors.gender&&formik.touched.gender)?formik.errors.gender:false}</FormHelperText>
        </FormControl>
        ...
        <TextField
          ...
          variant="outlined"
          name="guardianName"
          error={!!formik.errors.guardianName&&formik.touched.guardianName}
          helperText={(!!formik.errors.guardianName&&formik.touched.guardianName) ?formik.errors.guardianName:""}
